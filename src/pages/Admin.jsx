...
function Admin() {
  ...
  return (
    <div className="page">
      <h1 className="text-3xl font-semibold mb-4">{t('admin', { ns: 'admin' })}</h1>
      ...
      <div className="max-w-md mx-auto">
        ...
        <label htmlFor="email" className="block text-gray-700 text-sm font-bold mb-2">{t('email', { ns: 'admin' })}</label>
        <input
          type="email"
          id="email"
          name="email"

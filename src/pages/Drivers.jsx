      ...
      const handleAddDriver = async () => {
        try {
          ...
          if (error) {
            ...
            alert(t('driverAddedSuccessfully'));
            fetchDrivers();
            setNewDriver({
              full_name: '',
              address: '',
          ...
          <div className="page">
            <div className="max-w-5xl mx-auto mt-8"> {/* Added max-w-5xl and mt-8 */}
              <div className="flex justify-end items-center mb-4">
                ...
                >
                  <img src="https://ticghrxzdsdoaiwvahht.supabase.co/storage/v1/object/public/assets/Navigation/plus.png" alt={t('addDriver')} style={{ width: '20px', height: '20px' }} />
                </button>
              </div>
                      ...
                      <tr key={driver.id} className="hover:bg-gray-100">
                        ...
                        <TableData>
                          {driver.drivers_license_photo && (
                            <img src={driver.drivers_license_photo} alt={t('driversLicensePhoto')} style={{ width: '100px' }} />
                          )}
                        </TableData>
                        <TableData>
                          {driver.police_records_photo && (
                            <img src={driver.police_records_photo} alt={t('policeRecord')} style={{ width: '100px' }} />
                          )}
                        </TableData>
                        <TableData>
                          {driver.criminal_records_photo && (
                            <img src={driver.criminal_records_photo} alt={t('criminalRecord')} style={{ width: '100px' }} />
                          )}
                        </TableData>
                        <TableData>
                          {driver.profile_photo && (
                            <img src={driver.profile_photo} alt={t('profilePhoto')} style={{ width: '100px' }} />
                          )}
                        </TableData>
                        <TableData>
                          <button onClick={() => handleEditClick(driver)} className="text-blue-500 hover:text-blue-700 mr-2">{t('edit')}</button>
                          <button onClick={() => handleDelete(driver.id)} className="text-red-500 hover:text-red-700">{t('delete')}</button>
                          <button onClick={() => handleViewDetails(driver)} className="text-blue-500 hover:text-blue-700">{t('viewDetails')}</button>
                        </TableData>
                      </tr>
                    ))}
                  </tbody>
              ...
              <Modal isOpen={showAddForm} onClose={handleCloseModal}>
                ...
                <label htmlFor="police_records_photo" className="block text-gray-700 text-sm font-bold mb-2">{t('policeRecordsPhoto')}</label>
                ...
                <label htmlFor="criminal_records_photo" className="block text-gray-700 text-sm font-bold mb-2">{t('criminalRecordsPhoto')}</label>
                ...
                <label htmlFor="profile_photo" className="block text-gray-700 text-sm font-bold mb-2">{t('profilePhoto')}</label>

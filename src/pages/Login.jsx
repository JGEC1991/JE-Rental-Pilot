      ...
      return (
        <div className="flex h-screen bg-gray-100">
          ...
          <div className="w-full lg:w-1/2 bg-gray-800 text-white flex flex-col justify-center items-center p-12">
            <h1 className="text-3xl font-bold mb-6">Welcome to CarFleet Pro</h1>
            <p className="text-lg text-center">
              Manage your entire vehicle fleet with ease. Track maintenance, assign drivers, and keep your operations running smoothly with our comprehensive fleet management solution.
            </p>
          </div>
        </div>
      );

  ...
  return (
    <div className="container mx-auto px-4 py-8">
        ...
        <table className="border-collapse table-auto w-full whitespace-nowrap bg-white table-striped relative">
          <thead>
            <tr>
              ...
              <TableHeader>Related Activity</TableHeader>
      ...
      <Modal isOpen={showAddForm} onClose={handleCloseModal}>
        ...
        <div className="mb-4">
          <label htmlFor="activity_id" className="block text-gray-700 text-sm font-bold mb-2">Related Activity (Optional)</label>
          <select
            id="activity_id"
            name="activity_id"
        ...
        <div className="mb-4">
          <label htmlFor="driver_id" className="block text-gray-700 text-sm font-bold mb-2">Driver (Optional)</label>
          <select
            id="driver_id"
            name="driver_id"
      ...
      <Modal isOpen={showEditForm} onClose={handleCloseModal}>
        ...
        {selectedExpense && (
          <>
            <div className="mb-4">
              <label htmlFor="edit-activity_id" className="block text-gray-700 text-sm font-bold mb-2">Related Activity (Optional)</label>
              <select
                id="edit-activity_id"
                name="activity_id"
            ...
            <div className="mb-4">
              <label htmlFor="edit-vehicle_id" className="block text-gray-700 text-sm font-bold mb-2">Vehicle</label>
              <select
                id="edit-vehicle_id"
                name="vehicle_id"
            ...
            <div className="mb-4">
              <label htmlFor="edit-driver_id" className="block text-gray-700 text-sm font-bold mb-2">Driver (Optional)</label>
              <select
                id="edit-driver_id"
                name="driver_id"
            ...
            <div className="mb-4">
              <label htmlFor="edit-category" className="block text-gray-700 text-sm font-bold mb-2">Expense Category</label>
              <select
                id="edit-category"
                name="category"
            ...
            <div className="mb-4">
              <label htmlFor="edit-amount" className="block text-gray-700 text-sm font-bold mb-2">Amount</label>
              <input
                type="number"
                id="edit-amount"
                name="amount"
            ...
            <div className="mb-4">
              <label htmlFor="edit-date" className="block text-gray-700 text-sm font-bold mb-2">Date</label>
              <input
                type="date"
                id="edit-date"
                name="date"
